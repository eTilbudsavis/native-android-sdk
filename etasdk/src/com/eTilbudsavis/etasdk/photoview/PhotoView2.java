...
public class PhotoView2 extends ImageView implements IPhotoView2, View.OnTouchListener,
OnGestureListener,
ViewTreeObserver.OnGlobalLayoutListener {

	public static final String TAG = PhotoView2.class.getSimpleName();
	...
	public PhotoView2(Context context, AttributeSet attrs, int defStyle) {
                ...
                new GestureDetector.SimpleOnGestureListener() {
                    ...
                    public void onLongPress(MotionEvent e) {
                        if (null != mLongClickListener) {
                            mLongClickListener.onLongClick(PhotoView2.this);
                        }
                    }
                });
...
//        }
    ...
    private void checkZoomLevels(float minZoom, float maxZoom) {
    	PhotoViewHelper.checkZoomLevels(minZoom, maxZoom);
    }
    ...
    private boolean hasDrawable() {
    	return PhotoViewHelper.hasDrawable(this);
    }
    ...
    private boolean isSupportedScaleType(final ScaleType scaleType) {
    	return PhotoViewHelper.isSupportedScaleType(scaleType);
    }

    private int getImageViewWidth() {
    	return PhotoViewHelper.getImageViewWidth(this);
    }
    
    private int getImageViewHeight() {
    	return PhotoViewHelper.getImageViewHeight(this);
    }
    ...
    private void setImageViewScaleTypeMatrix() {
    	PhotoViewHelper.setImageViewScaleTypeMatrix(this);
    }
    ...
    private class AnimatedZoomRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (t < 1f) {
                Compat.postOnAnimation(PhotoView2.this, this);
            }
	...
	public boolean onTouch(View v, MotionEvent event) {
        ...
        if (mZoomEnabled && PhotoViewHelper.hasDrawable((ImageView) v)) {
