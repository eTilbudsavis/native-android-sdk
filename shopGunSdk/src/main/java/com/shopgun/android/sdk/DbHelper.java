...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private DbHelper(ShopGun shopGun) {
        super(shopGun.getContext(), DB_NAME, null, DB_VERSION);
        mShopGun = shopGun;
    }

    public static DbHelper getInstance(ShopGun shopGun) {
        if (mDbHelper == null) {
            mDbHelper = new DbHelper(shopGun);
        }
        return mDbHelper;
    }
