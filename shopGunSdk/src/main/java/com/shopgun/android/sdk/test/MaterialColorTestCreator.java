...
public class MaterialColorTestCreator {
    ...
    public static void generateTests() {
        ...
        for (Map.Entry<String, Integer> e : ALL.entrySet()) {
            ...
            MaterialColor color = new SgnColor(e.getValue());
    ...
    public static void addTests(Map<MaterialColor, MaterialTestColor> map) {
        ...
        map.put(new SgnColor(0xFF20325A), Føtex);
        ...
        map.put(new SgnColor(0xFFECECEC), Humac);
        ...
        map.put(new SgnColor(0xFFFFFFFF), SøstreneGrene);
        ...
        map.put(new SgnColor(0xFF034899), Rema);
        ...
        map.put(new SgnColor(0xFFED1C24), Spar);
        ...
        map.put(new SgnColor(0xFF00FF00), Green);
        ...
        map.put(new SgnColor(0xFF3B3F00), Flugger);
        ...
        map.put(new SgnColor(0xFF3350A0), Silvan);
        ...
        map.put(new SgnColor(0xFFFFDF00), Netto);
        ...
        map.put(new SgnColor(0xFF0000FF), Blue);
        ...
        map.put(new SgnColor(0xFFFF0000), Red);
        ...
        map.put(new SgnColor(0xFFF0393D), SuperBrugsen);
        ...
        map.put(new SgnColor(0xFFCD0931), Meny);
        ...
        map.put(new SgnColor(0xFF000000), Black);
        ...
        map.put(new SgnColor(0xFF7B9119), eTilbudsavis);
        ...
        map.put(new SgnColor(0xFFEE1E79), ShopGun);
        ...
        map.put(new SgnColor(0xFFFFFFFF), White);
