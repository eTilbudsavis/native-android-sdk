...
import com.shopgun.android.sdk.pagedpublicationkit.impl.apiv2.quatzel.PageEvent;
import com.shopgun.android.sdk.pagedpublicationkit.impl.apiv2.quatzel.PageflipStatsCollector;
...
public class PageflipStatsCollectorImpl implements PageflipStatsCollector {
    ...
    public PageflipStatsCollectorImpl(String viewSession, Catalog catalog, int[] pages, CatalogConfiguration config, Clock clock, StatDelivery delivery) {
    ...
    private void log(String s) {
        if (LOG) {
            SgnLog.d(TAG, "page[" + TextUtils.join("-", mPages) + "] " + s);
        }
    }
    ...
    public String toString() {
        ...
        return String.format(format, getClass().getSimpleName(), mViewSession, mCatalogId, TextUtils.join("-", mPages), mOrientation.toString(), mClock.getClass().getSimpleName(), mDelivery.getClass().getSimpleName());
    }
}
