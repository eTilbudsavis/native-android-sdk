...
public class Event implements RealmModel {
    ...
    private int mType;
    @Ignore private String mTypeToString;   // Human readable version for the type
    ...
    */
    ...
    /**
     * Set the type for the event.
     * @param type positive integer
     * @param typeForPrint string version for print on console
     */
    public void setType(int type, String typeForPrint) {
        setType(type);
        mTypeToString = typeForPrint;
    }

    public String getTypeToString() {
        return mTypeToString;
    }
    ...
    public String toString() {
        ...
        sb.append("event id (_i): ").append(mId).append(", ")
                ...
                .append(" ").append(mTypeToString).append(", ")
